...
function main() {
  ...
  const partnerNames = ['John', 'Joe', 'Jane', 'Jack', 'James'];

  const locations = ['Amsterdam', 'Rotterdam', 'Arnhem', 'Zwolle', 'Utrecht'];

  const jobTitles = ['Teacher', 'Web Developer', 'Salesforce Developer', 'Driver', 'Police'];
