...
exports.clearCachedFiles = exports.getLanguagesForExt = exports.ExclusionHelper = exports.resolveFile = exports.Link = exports.Text = exports.constructSettingsForText = exports.combineTextAndLanguageSettings = exports.refreshDictionaryCache = exports.getDictionary = exports.createSpellingDictionary = exports.CompoundWordsMethod = exports.defaultSettingsFilename = exports.validateText = exports.IncludeExcludeFlag = exports.checkText = void 0;
...
Object.defineProperty(exports, "defaultSettingsFilename", { enumerable: true, get: function () { return Settings_1.defaultFileName; } });
...
Object.defineProperty(exports, "getDictionary", { enumerable: true, get: function () { return SpellingDictionary_1.getDictionary; } });
...
Object.defineProperty(exports, "constructSettingsForText", { enumerable: true, get: function () { return TextDocumentSettings_2.combineTextAndLanguageSettings; } });
const Text = __importStar(require("./util/text"));
exports.Text = Text;
const Link = __importStar(require("./Settings/link"));
exports.Link = Link;
...
async function clearCachedFiles() {
    await Promise.all([Settings_2.clearCachedSettingsFiles(), SpellingDictionary_2.refreshDictionaryCache(0)]);
}
